...
Se puede hacer zoom in y zoom out al gráfico interactivo para entrar en los detalles de cada punto. 

¿Qué significa cada punto? Es un bus de la región Metropolitana. Al pasar por cada uno de los puntos, aparece una "tabla": 

- Código de bus = Nombre del bus
- Zona = Lugar por donde recorre principalmente el bus
- Frecuencia Punta = Frecuencia del bus en el horario punta por hora
- Frecuencia Valle = Frecuencia del bus en el horario valle por hora

![alt text](<figura intro cronica.png>)
...
![alt text](<figuras para crónica/figura 1 crónica.png>)
...
![alt text](<figuras para crónica/figura 2 crónica.png>)

 Mientras más cerca de la línea diagonal estén los puntos significa que esos buses tienen una frecuencia en el horario valle y punta muy similar o incluso igual. Por otra parte hay buses que tienen una frecuencia mucho mayor en un horario. Por ejemplo, lo que sucede con la D20, que es particularmente extraña pues en el horario valle tiene una frecuencia mucho mayor.

![alt text](<figuras para crónica/figura 3 cronica.png>)
