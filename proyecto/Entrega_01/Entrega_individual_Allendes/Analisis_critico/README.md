...
* Mi objetivo es comprobar si los habitantes de las comunas periféricas sufren una segregación del tiempo" en comparación con otras comunas con más recursos. Me gustaría revisar si los datos del DTPM realmente muestran una desconexión técnica y geográfica, es decir, la oferta de buses no se distribuye donde hay más necesidad o se hace de manera parcial. 
* Con esto espero demostrar que una persona de Puente Alto o La Pintana no solo viaja más, sino que espera más tiempo en condiciones de hacinamiento porque el sistema no ha ajustado su frecuencia a los puntos críticos de demanda real. El punto final sería demostrar si el diseño del transporte público de la Región Metropolitana actúa como un agente de estrés y precarización de la salud mental para partes importantes de la población de la región.
